...
async def pause(_, message: Message):
    ...
    if (chat_id not in callsmusic.active_chats) or (
        ...
        await message.reply_text("❗ Nothing is playing on VC!")
    else:
        callsmusic.pause(chat_id)
        await message.reply_text("🎧 Paused tha music!")
...
async def resume(_, message: Message):
    ...
    if (chat_id not in callsmusic.active_chats) or (
        ...
        await message.reply_text("❗ Nothing is paused tha song!")
    else:
...
async def stop(_, message: Message):
    ...
    if chat_id not in callsmusic.active_chats:
        await message.reply_text("❗ Nothing is streaming your group!")
    else:
        try:
        ...
        await message.reply_text("❌ Stopped streaming on your group!")
